<?php echo form_open('ruang/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_INSTANSI_PENDIDIKAN" class="form-control">
				...
				{
					$selected = ($instansi_pendidikan['ID_INSTANSI_PENDIDIKAN'] == $this->input->post('ID_INSTANSI_PENDIDIKAN')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="NAMA_RUANG" class="form-control" id="NAMA_RUANG"><?php echo $this->input->post('NAMA_RUANG'); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="KETERANGAN_RUANG" class="col-md-4 control-label">KETERANGAN RUANG</label>
		<div class="col-md-8">
			<textarea name="KETERANGAN_RUANG" class="form-control" id="KETERANGAN_RUANG"><?php echo $this->input->post('KETERANGAN_RUANG'); ?></textarea>
		</div>
	</div>

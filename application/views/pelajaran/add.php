<?php echo form_open('pelajaran/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="NAMA_PELAJARAN" class="form-control" id="NAMA_PELAJARAN"><?php echo $this->input->post('NAMA_PELAJARAN'); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="KETERANGAN_PELAJARAN" class="col-md-4 control-label">KETERANGAN PELAJARAN</label>
		<div class="col-md-8">
			<textarea name="KETERANGAN_PELAJARAN" class="form-control" id="KETERANGAN_PELAJARAN"><?php echo $this->input->post('KETERANGAN_PELAJARAN'); ?></textarea>
		</div>
	</div>

<?php echo form_open('menu/edit/'.$menu['ID_MENU'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_DETAIL_MENU" class="form-control">
				...
				{
					$selected = ($detail_menu['ID_DETAIL_MENU'] == $menu['ID_DETAIL_MENU']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_STATUS_USER" class="form-control">
				...
				{
					$selected = ($status_user['ID_STATUS_USER'] == $menu['ID_STATUS_USER']) ? ' selected="selected"' : "";

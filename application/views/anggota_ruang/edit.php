<?php echo form_open('anggota_ruang/edit/'.$anggota_ruang['ID_ANGGOTA_RUANG'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_USER" class="form-control">
				...
				{
					$selected = ($user['ID_USER'] == $anggota_ruang['ID_USER']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_RUANG" class="form-control">
				...
				{
					$selected = ($ruang['ID_RUANG'] == $anggota_ruang['ID_RUANG']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="IDENTIFIER_ANGGOTA" class="form-control" id="IDENTIFIER_ANGGOTA"><?php echo ($this->input->post('IDENTIFIER_ANGGOTA') ? $this->input->post('IDENTIFIER_ANGGOTA') : $anggota_ruang['IDENTIFIER_ANGGOTA']); ?></textarea>

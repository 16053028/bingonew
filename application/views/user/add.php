	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_USER_DETAILS" class="form-control">
				...
				{
					$selected = ($user_detail['ID_USER_DETAILS'] == $this->input->post('ID_USER_DETAILS')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_TBL_LOGIN" class="form-control">
				...
				{
					$selected = ($login['ID_TBL_LOGIN'] == $this->input->post('ID_TBL_LOGIN')) ? ' selected="selected"' : "";

<?php echo form_open('detail_kartu_bingo/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="ID_KARTU_BINGO" class="form-control">
				...
				{
					$selected = ($kartu_bingo['ID_KARTU_BINGO'] == $this->input->post('ID_KARTU_BINGO')) ? ' selected="selected"' : "";
